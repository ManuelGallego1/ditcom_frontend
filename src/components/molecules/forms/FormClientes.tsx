...
import { clienteScheme } from '@/src/schemes/ClienteScheme';
import { ClienteDTO } from '@/src/interfaces/ClienteInterface';
import { createCliente } from '@/src/libs/clientes-service';
