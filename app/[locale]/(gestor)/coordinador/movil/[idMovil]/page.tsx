...
import MovilDetail from '@/modules/admin/moviles/MovilDetail';
import { notFound } from 'next/navigation';
import { getMovilByIdServer } from '@/libs/movil-server-service';
...
export async function generateMetadata({
    ...
    try {
        ...
        return {
            title: `Coordinador Móvil - ${movil.min} | Ditcom`,
